function jsaipotu(){
  ...
  jsaipotu.__sendStats = sendStats;
  jsaipotu.__moduleName = $intern_4;
  jsaipotu.__errFn = null;
  jsaipotu.__moduleBase = $intern_6;
  jsaipotu.__softPermutationId = $intern_7;
  jsaipotu.__computePropValue = null;
  jsaipotu.__getPropMap = null;
  jsaipotu.__installRunAsyncCode = function(){
  }
  ;
  jsaipotu.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  jsaipotu.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  jsaipotu.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  jsaipotu.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[jsaipotu.__softPermutationId];
    ...
    function installCode(code_0){
      ...
      if (jsaipotu.__errFn) {
        script.onerror = function(){
          jsaipotu.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  jsaipotu.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  jsaipotu.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    jsaipotu.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return jsaipotu.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    jsaipotu.__getPropMap = function(){
      var result = {};
    ...
    ;
    jsaipotu.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = jsaipotu.__getPropMap;
    ...
    jsaipotu.__softPermutationId = softPermutationId;
  ...
  processMetas();
  jsaipotu.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = jsaipotu.__moduleBase;
