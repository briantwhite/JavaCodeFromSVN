 ...
 * 
 * @author Brian White
 * @version 1.0 $Id: ThreeAlleleCircularDominanceGeneModel.java,v 1.7 2008-06-20 02:16:04 brian Exp $
 */
...
public class ThreeAlleleCircularDominanceGeneModel extends GeneModel {
	...
	public ThreeAlleleCircularDominanceGeneModel(List<Element> traitList) {
		super();
