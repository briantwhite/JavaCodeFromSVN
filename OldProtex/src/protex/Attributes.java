...
public class Attributes implements Cloneable {
	...
	public Attributes(String inputString, 
		...
		this(inputString, "standard", breakTies, "hexagonal", "incremental",
				"8", "4", "0.1", "0.5", "1.0", ppId, ppFH);
	}
