...
public class ShapeMatcher {
	...
	public ShapeMatcher(String targetString) {
		...
		HexGrid targetGrid = ProteinImageGenerator.layoutOntoHexGrid(targetDirections);
	...
	public boolean matchesTarget(String guessDirectionString) {

		guessDirectionString = guessDirectionString.trim();
		// read in guess direction list
		String[] guessStrings = guessDirectionString.split(";");
	...
	private boolean isSameShape(Direction[] guessDirections) {
		...
		HexGrid guessGrid = ProteinImageGenerator.layoutOntoHexGrid(guessDirections);
