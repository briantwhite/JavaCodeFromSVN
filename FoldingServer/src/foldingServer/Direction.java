...
public class Direction {
	...
	public static Direction increment(Direction d) {
	...
	//utility method for printing a Direction[]
	// so that it can be included in a target_shape file
	//  for viewing
	public static void print(Direction[] array) {
		System.out.print(" ,");
