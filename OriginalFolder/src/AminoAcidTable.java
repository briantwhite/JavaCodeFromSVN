...
/**
 * Model a table of AminoAcids.
 * Serves too as a table factory.
 */
public abstract class AminoAcidTable
{
     ...
     * @throws FoldingException if operation not allowed.
     */
    public abstract void add( AminoAcid a )
	throws FoldingException;
     ...
     */
    public abstract AminoAcid get( String name )
	throws FoldingException;
     ...
     * @return an Iterator.
     *
     * @throws FoldingException if no Iterator available.
     */
