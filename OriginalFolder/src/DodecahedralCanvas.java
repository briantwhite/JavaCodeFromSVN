 ...
 */
public class DodecahedralCanvas extends GridCanvas
{
    private int cellHeight   = 2*cellRadius;

    private int xOffset    = (int)(0.6  * cellRadius);
    private int yOffset    = (int)(0.7  * cellRadius);
    private int acidRadius = (int)(1.2  * cellRadius);

    public DodecahedralCanvas(int width, int height )
    {
	super(width, height);
    }
