package protex.client.java.awt;
...
import protex.client.java.awt.BasicStroke;
import protex.client.java.awt.Color;
import protex.client.java.awt.Component;
import protex.client.java.awt.Shape;
import protex.client.java.awt.geom.PathIterator;
...
public class Graphics implements GraphicsInterface {
  ...
  public Graphics(Context2d context, Component component) {
    this.context = context;
  ...
  //ADDED
  public void drawFilledString(String str, int x, int y, String font, Color color) {
	  context.save();
	  setFillColor(color);
	  setFont(font);
