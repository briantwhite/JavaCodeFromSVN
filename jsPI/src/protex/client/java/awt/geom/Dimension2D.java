...
public abstract class Dimension2D { //implements Cloneable {
  ...
  /**
   * Sets the size of this <code>Dimension2D</code> object to match the specified size. This method
   * is included for completeness, to parallel the <code>getSize</code> method of
   * <code>Component</code>.
   * 
