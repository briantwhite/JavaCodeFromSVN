...
public abstract class Node extends ModelElement implements Cloneable {
	...
	public void addConnectionTo(Node n) {
		...
		System.out.println(new StringBuffer("AddConnection: connected ")
		.append(getName()).append(" (").append(getId()).append(") to ")
		.append(n.getName()).append(" (").append(n.getId()).append(")").toString());
	}
