...
public class jlogp extends JApplet {
	...
	JButton aboutButton = new JButton("<html><font size=-2>About jlogP</font></html>");
	
	public void init() {
		aboutButton.setBackground(new Color(220,220,220));
		southPanel.add(aboutButton);
		southPanel.setBackground(new Color(220,220,220));
//		southPanel.setBorder(BorderFactory.createLineBorder(Color.BLACK));
		centerPanel.add(outputInfo);
		centerPanel.setBackground(new Color(240,240,240));
		centerPanel.setBorder(BorderFactory.createTitledBorder("jlogP version " 
				+ versionNumber ));
